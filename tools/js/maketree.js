...
function buildTree(containerName, customOptions)
{
    ...
    {
        return d.events && d.events.length > 0 ? d.events : null;
    });
    ...
    var tree = d3.layout.tree()
        ...
        .children(function(d)
        {
            return (!d.events || d.events.length === 0) ? null : d.events;
        });
    ...
    nodeGroup.append("svg:text")
        ...
        .text(function(d)
        {
            if (d.time) {
                ...
                if (d.name.indexOf("fail") != -1) {
                    alert("FSM Test Failed")
                }
                return d.name
            }
        });
